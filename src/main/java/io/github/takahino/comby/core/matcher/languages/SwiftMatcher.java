...
public class SwiftMatcher extends AbstractLanguageMatcher {
    ...
    @Override public String name() { return "swift"; }
    @Override public List<String> extensions() { return List.of(".swift"); }
