...
public class ScalaMatcher extends AbstractLanguageMatcher {
    private static final LanguageSyntax SYNTAX = new LanguageSyntax(
        ...
        List.of(
            ...
            LanguageSyntax.CommentSyntax.block("/*", "*/", true)
        ),
        List.of("(", "{", "["),
        List.of(")", "}", "]")
    );

    @Override public String name() { return "scala"; }
    @Override public List<String> extensions() { return List.of(".scala", ".sc"); }
