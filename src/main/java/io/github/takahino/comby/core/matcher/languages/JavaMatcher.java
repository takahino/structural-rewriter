...
public class JavaMatcher extends AbstractLanguageMatcher {
    private static final LanguageSyntax SYNTAX = new LanguageSyntax(
        List.of(
            new LanguageSyntax.StringDelimiter("\"", "\"", true),
            new LanguageSyntax.StringDelimiter("'", "'", true),
            new LanguageSyntax.StringDelimiter("\"\"\"", "\"\"\"", false)  // text block
        ),
        List.of(
    ...
    @Override public List<String> extensions() { return List.of(".java"); }
