...
import io.github.takahino.comby.core.matcher.tokenizer.CombySqlTokenizer;

import java.util.List;

public class SqlMatcher extends AbstractLanguageMatcher {
    ...
    @Override public List<String> extensions() { return List.of(".sql"); }
    @Override public LanguageSyntax syntax() { return SYNTAX; }
    @Override public StructuralTokenizer tokenizer() { return new CombySqlTokenizer(); }
}
