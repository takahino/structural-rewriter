...
import io.github.takahino.comby.core.matcher.tokenizer.CombyGoTokenizer;

import java.util.List;

public class GoMatcher extends AbstractLanguageMatcher {
    private static final LanguageSyntax SYNTAX = new LanguageSyntax(
        List.of(
            new LanguageSyntax.StringDelimiter("`", "`", false),  // raw string
    ...
    @Override public List<String> extensions() { return List.of(".go"); }
    @Override public LanguageSyntax syntax() { return SYNTAX; }
    @Override public StructuralTokenizer tokenizer() { return new CombyGoTokenizer(); }
}
